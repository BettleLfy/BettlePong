...
def ball_restart():
    ...
    if current_time - score_time < 700:
        ...
        screen.blit(number_three, (screen_width / 2 - 13, screen_height / 2 + 70))
    
    if 700 < current_time - score_time < 1400:
        number_two = game_font.render('2', False, light_grey)
        screen.blit(number_two, (screen_width / 2 - 13, screen_height / 2 + 70))
        
    if 1400 < current_time - score_time < 2100:
        number_one = game_font.render('1', False, light_grey)
        screen.blit(number_one, (screen_width / 2 - 13, screen_height / 2 + 70))
...
while True:
    ...
    enemy_text = game_font.render(f'{enemy_score}', False, light_grey)
